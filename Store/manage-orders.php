                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo SITEURL; ?>store/update-order.php?id=<?php echo $id; ?>" class="btn-secondary">Update Order</a>
                                          <br><td><!--<a href="delete-order.php"  style='background:red; colour:black; padding: 5px;' class="btn-secondary">Delete</a>-->
