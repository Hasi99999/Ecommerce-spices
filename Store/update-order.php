        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                else
                {
                    ...
                    header('location:'.SITEURL.'store/manage-order.php');
                }
            }
            else
            {
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql2 = "UPDATE orders SET 
                    ...
                    mysqli_stmt_bind_param($stmt, "iisssssi", $qty, $total, $status, $customer_name, $customer_contact, $customer_email, $customer_address, $id);
